const CACHE='rejser-v1-20260914-12';
const CORE=[
  ...
  './athen-2026.html','./athen-2026.css','./athen-2026.js','./data/athen-2026.json','./data/athen-food.json','./data/athen-stay.json','./assets/athen-banner.svg',
