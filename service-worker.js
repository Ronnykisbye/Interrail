const CACHE='rejser-v1-20260918-2';
const CORE=[
  ...
  './athen-2026.html','./athen-2026.css','./athen-2026.js','./data/athen-2026.json','./data/athen-food.json','./data/athen-stay.json','./data/athen-practical.json','./data/athen-tickets.json','./assets/athen-banner.svg',
